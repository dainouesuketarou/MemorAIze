...
import { speakFrontOrBack, extractPlainText, speak } from '@/src/lib/speech';
import { SettingModal } from '@/src/components/study/SettingModal';
import { useDeckSetting } from '@/src/hooks/useDeckSetting';
...
import {
  saveProgress,
  clearProgress,
} from '@/src/lib/store/slices/studyProgressSlice';
import {
  updateDeckProgress,
...
import {
  ...
  updateCardStatus,
  toggleFavorite,
} from '@/src/lib/store/slices/studySlice';
